...
def generate_launch_description():
    ...
    camera_tf = LaunchConfiguration('camera_tf', default='camera_infra1_frame')

    cmd_dfs_mode = DeclareLaunchArgument('dfs_mode', default_value=dfs_mode, description='0 CVP, 1 Coverage, 2 Speed, 3 Accuracy, 4 Normal')
