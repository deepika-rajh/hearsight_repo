...
private:
    ...
    void processColor();
    void callbackTwoImgs(const sensor_msgs::msg::Image::ConstSharedPtr& img_p1, const sensor_msgs::msg::Image::ConstSharedPtr& img_p2);
    ...
    void parseCameraInfo(const sensor_msgs::msg::CameraInfo& cm1, const sensor_msgs::msg::CameraInfo& cm2);
    ...
    rvDFS_InputParam_V1_t in;
    rvDFS_OutputParam_V1_t out;
