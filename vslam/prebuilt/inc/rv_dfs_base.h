...
template <typename T> class DFSBase {
public:
  //------------------------------------------------------------------------------
  /// @detailed
  ...
  //------------------------------------------------------------------------------
  virtual bool initialize(const rvDFSParameter &dfs_parameter,
                          const rvStereoCamera &stereo_parameter) = 0;
  ...
  ///   Returns True if success or False if failure
  //------------------------------------------------------------------------------
  virtual bool compute(const rvDFSInputParam *in, rvDFSOutputParam *out) = 0;
  ...
  ///   Returns True if success or False if failure
  //------------------------------------------------------------------------------
  virtual bool depth2PointCloud(const T *depth, PointCloudType<T> *pointCloud,
                                rvStereoCamera *param,
                                float *poseCameraInWorld) = 0;
