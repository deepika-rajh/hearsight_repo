 ...
 * ********************************/
RV_API void rvQueryOpenCLInfo(char *info);
...
/************************************************************************/ /**
 @detailed
    ...
    - \b Polynomial4 = Four parameter polynomial[k1, k2, p1, p2] plumb - line(
 a.k.a., Brown - Conrady ) model[D.C.Brown, "Photometric Engineering", Vol. 32,
 No. 3, pp.444 - 462 (1966)].Compatible with the oldest Caltech Matlab
 Calibration Toolbox.  To fill from OpenCV, declare cv::Mat for distortions with
 5 rows( 1 columns ), set it to zeros and use flag cv::CALIB_FIX_K3 with
    cv::calibrateCamera.\n
    - \b Polynomial5 = Five parameter polynomial[k1, k2, p1, p2, k3] plumb -
 line model. Compatible with current Matlab toolbox.To fill from OpenCV, declare
