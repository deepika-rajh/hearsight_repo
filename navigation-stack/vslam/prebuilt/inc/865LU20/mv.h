...
@section Overview
   ...
   - Stereo Auto-Calibration (SAC) for on-line calibration of a stereo camera
     rig.
...
@brief
   ...
   cameras in the QTI Flight stereo kit are laid out in such a way
   ...
   and camera[1] for the QTI Flight stereo kit.  This is the same
...
@param translation[3]
   ...
   value for the QTI Flight stereo kit since camera[1] is approximately
...
@brief
   ...
   For differences with mvPose6DET.
...
/***************************************************************************//**
@brief
   Invert mvPose6DRT in place, computes pose = pose^-1
*******************************************************************************/
...
/***************************************************************************//**
@brief
   Rotation matrix (3DR) to rotation vector representation (3DV)
*******************************************************************************/
MV_API void mv3DRto3DV( float32_t pose3DR[3][3], float32_t pose3DV[3] );



/***************************************************************************//**
@brief
   Rotation vector representation (3DV) to rotation matrix (3DR)
*******************************************************************************/
MV_API void mv3DVto3DR( float32_t pose3DV[3], float32_t pose3DR[3][3] );
