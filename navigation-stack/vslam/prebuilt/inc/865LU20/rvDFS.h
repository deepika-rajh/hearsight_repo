...
extern "C"
{
    ...
    //------------------------------------------------------------------------------
    RV_API rvDFS* rvDFS_Initialize(rvDFSMode dfs_mode, int width, int height, int stride, const rvDFSParameter dfs_parameter, const rvStereoCamera stereo_parameter);
