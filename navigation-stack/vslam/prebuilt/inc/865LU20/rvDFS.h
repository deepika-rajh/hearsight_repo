...
extern "C"
{
	...
	/// @param pointCloud
        ...
        ///   Returns True if success or False if failure
	//------------------------------------------------------------------------------
	bool RV_API rvDFS_CalculateDispDepthPointCloud(rvDFS* pHandle, uint8_t* imgL, uint8_t* imgR, float* disparities, float* depth, PointCloudType* pointCloud);
	...
	/// @param pointCloud
        ...
        ///   Returns True if success or False if failure
	//------------------------------------------------------------------------------
	bool RV_API rvDFS_CalculateDispDepthPointCloudWithNewDisparityRange(rvDFS* pHandle, uint8_t* imgL, uint8_t* imgR, float* disparities, float* depth, PointCloudType* pointCloud, rvDFSDisparity* dfs_disparity);


        //------------------------------------------------------------------------------
	/// @detailed
	///     Run rvDFS and get disparity/depth/point cloud fused with rectified left gray image
        /// @param pHandle
        ///   Handle of rvDFS
        /// @param imgL
        ///   Left image pointer
	...
	//// @param pointCloud
        ...
        ///   Returns True if success or False if failure
	//------------------------------------------------------------------------------
	bool RV_API rvDFS_CalculateDispDepthPointCloudColor(rvDFS* pHandle, uint8_t* imgL, uint8_t* imgR, float* disparities, float* depth, PointCloudType* pointCloud, PointCloudColorType* pointCloudColor);


        //------------------------------------------------------------------------------
	/// @detailed
	///     Run rvDFS and get disparity/depth/point cloud fused with rectified left gray image with new disparity range
        /// @param pHandle
        ///   Handle of rvDFS
        /// @param imgL
        ///   Left image pointer
