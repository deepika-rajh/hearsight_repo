...
extern "C"
{
   ...
   //------------------------------------------------------------------------------
   RV_API rvVSLAM* rvVSLAM_Initialize( const rvCameraConfiguration *pnConfig, 
   ...
   ///     Reference robot odometry in VSLAM coordinate system.
   //------------------------------------------------------------------------------
   void RV_API rvVSLAM_AddImageDepth(rvVSLAM* pObj, int64_t t, const uint8_t* pxls, const uint16_t* depth, const rvPose6DRT * pPriorPose);
