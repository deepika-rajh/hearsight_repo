   ...
   if (auto video_profile = color_profile.as<rs2::video_stream_profile>())
   {
      try {
		 ...
		 printf("intrinsics coeffs: %.4f, %.4f, %.4f, %.4f, %.4f\n",
              ...
              configuration.stereo.camera[0].pixelWidth = intrinsics.width;
              configuration.stereo.camera[0].pixelHeight = intrinsics.height;
              configuration.stereoRect.camera[0].pixelWidth = intrinsics.width;
              configuration.stereoRect.camera[0].pixelHeight = intrinsics.height;

              
              configuration.stereo.camera[0].focalLength[0] = intrinsics.fx;
              configuration.stereo.camera[0].principalPoint[0] = intrinsics.ppx;
              configuration.stereo.camera[0].focalLength[1] = intrinsics.fy;
              configuration.stereo.camera[0].principalPoint[1] = intrinsics.ppy;
              
              
              configuration.stereo.camera[0].distortionModel = rvDistortionModel::NoDistortion;
              memset( configuration.stereo.camera[0].distortion, 0, sizeof( configuration.stereo.camera[0].distortion ) );
              configuration.stereo.camera[0].distortion[0] = intrinsics.coeffs[0];
              configuration.stereo.camera[0].distortion[1] = intrinsics.coeffs[1];
