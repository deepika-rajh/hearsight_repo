...
int main( int argc, char** argv )
{
   ...
   std::string algSetting="/data/misc/vwslam/Configuration/vm.cfg";
   ...
   //start VSLAM system
   std::shared_ptr<CameraInterface> inputCamera = std::make_shared<InputRGBDCameraROS2>(g_node);
   std::shared_ptr<VMSystem> sys = VMSystem::Initialize(algSetting, inputCamera, false);
